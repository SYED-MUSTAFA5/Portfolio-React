...
const Data = () => {
  ...
  const originalText = "Syed Mustafa Hussain";
  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">I'm a Web developer, and I'm very passionate and dedicated to my work.</p>

      <a href="https://www.linkedin.com/in/syed-mustafa-hussain-80947229a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="button button--flex">
        Say Hello
        <svg
